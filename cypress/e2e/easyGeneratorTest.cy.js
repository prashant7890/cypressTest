...
describe('Easy generator test ', () => {
  ...
  it(
    ...
    () => {
      dropDownTestData.dropDownValues.forEach((eachOption) => {
        ...
        cy.get(homePage.dropDown)
          .find(':selected')
          .should('have.text', eachOption.option)
      })
    },
  )
  ...
  it(
    ...
    () => {
      ...
      newWindowHandles({
        href: commonTestData.newTabLink,
        button: homePage.openTabButton,
      })
    },
  )
  ...
  it(
    ...
    () => {
      ...
      cy.get('header')
        .find('a')
        .should('have.attr', 'href', commonTestData.websiteLink)
      cy.get('header')
        .find('div > a')
        .should('have.attr', 'href', commonTestData.websiteLink)
    },
  ...
  it(
    ...
    () => {
      ...
      socialMediaData.socialMediaLinks.forEach((eachOption) => {
        cy.get(homePage.socialMediaFooter)
          .contains(eachOption.socialMedia)
